...
accelerate launch --num_processes ${NUM_GPUS} evaluation/shotvl/evaluate_internvl.py --model ${MODEL_NAME} --reasoning --output-dir ${OUTPUT_DIR} --category "${CATEGORY}"
...
# OPENAI_API_KEY=“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” python evaluation/calculate_scores.py --prediction_path ${PREDICTION_PATH} --category "${CATEGORY}"
